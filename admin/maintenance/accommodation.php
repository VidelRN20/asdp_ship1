...
<script>
	$(document).ready(function() {
		...
		$('#create_new').click(function() {
			uni_modal("<i class='fa fa-plus'></i> Add Ticket List", "maintenance/manage_accommodation.php", "mid-large")
		})
		$('.edit_data').click(function() {
			uni_modal("<i class='fa fa-plus'></i> Add Ticket List", "maintenance/manage_accommodation.php?id=" + $(this).attr('data-id'), "mid-large")
		})
		$('.table').dataTable();
	})
