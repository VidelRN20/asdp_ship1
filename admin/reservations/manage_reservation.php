		...
		<form action="" id="reservation-form">
			...
			<div class="row mb-2 border-bottom p-item">
				<div class="col-md-6">
					...
					<div class="form-group">
						<label for="" class="control-laberl">NIK</label>
						<input type="text" class="form-control form-control-sm rounded-0" name="NIK[]" value="<?php echo isset($NIK) ? $NIK : '' ?>" required>
					</div>
					<div class="form-group">
				...
				<div class="col-md-6">
					<div class="form-group">
						<label for="" class="control-laberl">Plat Nomor</label>
						<input type="text" class="form-control form-control-sm rounded-0" name="Plat_Nomor[]" value="<?php echo isset($Plat_Nomor) ? $Plat_Nomor : '' ?>" required>
					</div>
					<div class="form-group">
