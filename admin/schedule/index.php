			...
			<div class="container-fluid">
				<table class="table table-bordered table-stripped">
					...
					<tbody>
						...
						$qry = $conn->query("SELECT * FROM `schedules` ORDER BY UNIX_TIMESTAMP(departure_datetime) DESC, UNIX_TIMESTAMP(arrival_datetime) DESC");
...
<script>
	$(document).ready(function() {
		$('.delete_data').click(function() {
			_conf("Are you sure to delete this product permanently?", "delete_schedule", [$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
