...
<div class="card card-outline card-info">
    ...
    <div class="card-body">
        <form action="" id="schedule-form">
            ...
            <hr>
            <div class="row mb-2">
                <div class="col-md-2"><label for="accommodation">Ticket List</label></div>
                <div class="col-md-4">
                ...
                <div class="col-md-3">
                    <button class="btn btn-primary btn-flat btn-sm" type="button" id="add_to_list">Add to List</button>
                    <button class="btn btn-success btn-flat btn-sm" type="button" id="add_all">Add All</button>
                </div>
            </div>

            <script>
                $('#add_all').click(function() {
                    $("#accomodation_id option").each(function() {
                        var accom_id = $(this).val();
                        var accom_name = $(this).text();
                        if (accom_id > 0 && $('#accom_list tr[data-aid="' + accom_id + '"]').length <= 0) {
            ...
            <div class="form-group">
                <table class="table table-bordered border-hovered border-stripped" id="accom_list">
                    ...
                    <thead>
                        <tr>
                            <th class="py-1 px-2 text-center">Ticket List</th>
